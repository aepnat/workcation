<template>
  <div class="relative lg:z-10">
    <button @click="isOpen = !isOpen" class="relative z-10 block h-8 w-8 rounded-full overflow-hidden border-2 border-gray-600 focus:outline-none focus:border-white">
      <img class="h-full w-full object-cover object-center" src="https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=256&q=80" alt="Your avatar" />
    </button>
    ...
    <div v-if="isOpen" class="absolute top-auto right-0 mt-2 py-2 w-48 bg-white rounded-lg shadow-xl">
