<template>
  <header class="bg-gray-900 sm:px-4 sm:py-3">
    <div class="max-w-full lg:max-w-6xl mx-auto sm:flex sm:justify-between sm:items-center ">
      <div class="flex items-center justify-between px-4 py-3 sm:p-0">
        <div>
          <img class="h-8" src="/img/logo-inverted.svg" alt="Workcation">
        </div>
        <div class="sm:hidden">
          <button @click="isOpen = !isOpen" type="button" class="block text-gray-500 hover:text-white focus:outline-none">
      ...
      <div :class="isOpen ? 'block' : 'hidden'" class="sm:block">
        <div class="px-2 pt-2 pb-4 sm:block sm:flex sm:p-0">
        ...
        <div class="px-4 py-5 border-t border-gray-800 sm:hidden">
          <div class="flex items-center">
            ...
            <span class="font-semibold ml-3 text-white">Jane Doe</span>
          </div>
          <div class="mt-4">
